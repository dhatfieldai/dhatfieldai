...
**Senior Software Engineer | Python, ROR, Golang, React, Node.js, Pipedrive, AI Agent, SaaS, GHL, Metabase, Server Admin**<br/><br />
...
- **Full stack engineering** with Python (FastAPI / Django), Golang, React / Next.js, and Node.js
