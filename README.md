...
**Senior Software Engineer | Python, RoR, Golang, React, Vue, Node.js, AI Agent, SaaS, OpenMetadata, OpenRTB/Prebid Server**<br/><br />
...
- **Cloud & DevOps:** AWS, GCP, Docker, CI/CD, production deployment, scalable infrastructure
