...
**Senior Software Engineer | Python, .NET, Java, Golang, React, Node.js, AI Agent, SaaS, BigCommerce, Prebid Server/OpenRTB**<br/><br />
...
- **Full stack engineering** with Python (FastAPI / Django), .NET, Golang, React / Next.js, and Node.js
...
- **Backend:** Python, FastAPI, Django, .NET, Golang, Node.js, REST APIs, scalable backend systems
...
<p align="center">
  <a href="https://www.hackerrank.com/certificates/a6b79498b539" target="_blank">
    <img src="./react.png" alt="Certification 1" width="300" height="200" style="margin: 10px;">
  </a>
  <a href="https://www.hackerrank.com/certificates/9373c95d5f6a" target="_blank">
    <img src="./software engineer.png" alt="Certification 2" width="300" height="200" style="margin: 10px;">
  </a>
</p>
